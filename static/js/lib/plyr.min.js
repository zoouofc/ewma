"object" == typeof navigator && function(e, t) {
            ...
            if (Symbol.iterator in Object(e))
                return function(e, t) {
                    var i = []
                      ...
                      , s = void 0;
                    try {
                        for (var r, l = e[Symbol.iterator](); !(n = (r = l.next()).done) && (i.push(r.value),
                        !t || i.length !== t); n = !0)
                            ;
                    } catch (e) {
                        a = !0,
    ...
    function w(e, t, i) {
        ...
        return o.object(t) && k(n, t),
        o.string(i) && (n.innerText = i),
        n
    }
    function T(e, t, i, n) {
    ...
    function E(e, t) {
        return o.element(t) && o.element(t.parentNode) && o.element(e) ? (t.parentNode.replaceChild(e, t),
        e) : null
    }
    function S(e, t) {
        if (!o.string(e) || o.empty(e))
            return {};
        var i = {}
          , n = t;
    ...
    var I, O, j, R = (I = document.createElement("span"),
    O = {
    ...
    var H, V = {
        ...
        rangeInput: (H = document.createElement("input"),
        H.type = "range",
        "range" === H.type),
                ...
                Object.defineProperty(e.media, "quality", {
                    ...
                    set: function(t) {
                        ...
                        if (i) {
                            ...
                            ("none" !== r || l) && (e.once("loadedmetadata", function() {
                                e.currentTime = a,
                                s || e.play()
                            }),
                            e.media.load()),
        ...
        cancelRequests: function() {
            this.isHTML5 && (A(F.getSources.call(this)),
    ...
    function z() {
        ...
        return o.object(a) ? (Object.keys(a).forEach(function(t) {
            o.object(a[t]) ? (Object.keys(e).includes(t) || Object.assign(e, y({}, t, {})),
            z(e[t], a[t])) : Object.assign(e, y({}, t, a[t]))
        }),
    ...
    var se = {
        ...
        findElements: function() {
            try {
                return this.elements.controls = _.call(this, this.config.selectors.controls.wrapper),
                ...
                this.elements.progress = _.call(this, this.config.selectors.progress),
                ...
                o.element(this.elements.progress) && (this.elements.display.seekTooltip = this.elements.progress.querySelector("." + this.config.classNames.tooltip)),
                !0
            } catch (e) {
        ...
        createIcon: function(e, t) {
            ...
            var s = document.createElementNS("http://www.w3.org/2000/svg", "use")
              , r = n + "-" + e;
            return "href"in s ? s.setAttributeNS("http://www.w3.org/1999/xlink", "href", r) : s.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", r),
            a.appendChild(s),
            a
        },
        ...
        createButton: function(e, t) {
            var i = w("button")
              ...
              , c = void 0
              , u = void 0;
            switch ("type"in n || (n.type = "button"),
            "class"in n ? n.class.includes(this.config.classNames.control) || (n.class += " " + this.config.classNames.control) : n.class = this.config.classNames.control,
            e) {
            case "play":
                s = !0,
                r = "play",
            ...
            k(i, n),
            "play" === a ? (o.array(this.elements.buttons[a]) || (this.elements.buttons[a] = []),
            this.elements.buttons[a].push(i)) : this.elements.buttons[a] = i;
        ...
        createRange: function(e, t) {
            ...
            se.updateRangeFill.call(this, i),
            i
        },
        ...
        updateVolume: function() {
            this.supported.ui && (o.element(this.elements.inputs.volume) && se.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
            o.element(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume))
        },
        setRange: function(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
            o.element(e) && (e.value = t,
            se.updateRangeFill.call(this, e))
        },
            ...
            if (this.supported.ui && o.event(e)) {
                ...
                if (e)
                    ...
                    case "seeked":
                        ...
                        "timeupdate" === e.type && se.setRange.call(this, this.elements.inputs.seek, a);
                        break;
                    case "playing":
                    case "progress":
                        !function(e, i) {
            ...
            if (this.config.tooltips.seek && o.element(this.elements.inputs.seek) && o.element(this.elements.display.seekTooltip) && 0 !== this.duration) {
                ...
                if (this.touch)
                    ...
                    if (o.event(e))
                        ...
                        if (!L(this.elements.display.seekTooltip, a))
                            return;
                        i = parseFloat(this.elements.display.seekTooltip.style.left, 10)
                    }
                    i < 0 ? i = 0 : i > 100 && (i = 100),
                    se.updateTimeDisplay.call(this, this.elements.display.seekTooltip, this.duration / 100 * i),
                    this.elements.display.seekTooltip.style.left = i + "%",
                    o.event(e) && ["mouseenter", "mouseleave"].includes(e.type) && s("mouseenter" === e.type)
                }
            }
        },
        timeUpdate: function(e) {
            var t = !o.element(this.elements.display.duration) && this.config.invertTime;
            se.updateTimeDisplay.call(this, this.elements.display.currentTime, t ? this.duration - this.currentTime : this.currentTime, t),
            e && "timeupdate" === e.type && this.media.seeking || se.updateProgress.call(this, e)
        },
        durationUpdate: function() {
            if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
                ...
                !e && this.config.displayDuration && this.paused && se.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
                e && se.updateTimeDisplay.call(this, this.elements.display.duration, this.duration),
        ...
        setQualityMenu: function(e) {
            ...
            if (o.element(this.elements.settings.panes.quality)) {
                ...
                var n = !o.empty(this.options.quality);
                if (se.toggleTab.call(this, "quality", n),
        ...
        updateSetting: function(e, t, i) {
            ...
            if (o.element(s) || (s = n && n.querySelector("ul")),
            o.element(s)) {
        ...
        setCaptionsMenu: function() {
            ...
            if (se.toggleTab.call(this, "captions", i.length),
            C(t),
            se.checkMenu.call(this),
            i.length) {
        ...
        setSpeedMenu: function(e) {
            ...
            if (this.config.controls.includes("settings") && this.config.settings.includes("speed") && o.element(this.elements.settings.panes.speed)) {
                o.array(e) ? this.options.speed = e : (this.isHTML5 || this.isVimeo) && (this.options.speed = [.5, .75, 1, 1.25, 1.5, 1.75, 2]),
                this.options.speed = this.options.speed.filter(function(e) {
                    return t.config.speed.options.includes(e)
                });
                var i = !o.empty(this.options.speed) && this.options.speed.length > 1;
                if (se.toggleTab.call(this, "speed", i),
                se.checkMenu.call(this),
                i) {
        ...
        toggleMenu: function(e) {
            ...
            if (o.element(t) && o.element(i)) {
                ...
                n ? t.removeAttribute("tabindex") : t.setAttribute("tabindex", -1))
            }
        },
            ...
            if (o.element(n) && "tabpanel" === n.getAttribute("role")) {
                ...
                D.transitions && !D.reducedMotion) {
                    ...
                    d.call(this, s, R, function t(i) {
                        i.target === s && ["width", "height"].includes(i.propertyName) && (s.style.width = "",
                        s.style.height = "",
                        p.call(e, s, R, t))
                    }),
                ...
                n.querySelectorAll("button:not(:disabled), input:not(:disabled), [tabindex]")[0].focus()
            }
        },
        create: function(e) {
            var t = this;
            if (o.empty(this.config.controls))
                return null;
            var i = w("div", S(this.config.selectors.controls.wrapper));
            if (this.config.controls.includes("restart") && i.appendChild(se.createButton.call(this, "restart")),
            this.config.controls.includes("rewind") && i.appendChild(se.createButton.call(this, "rewind")),
            this.config.controls.includes("play") && i.appendChild(se.createButton.call(this, "play")),
            this.config.controls.includes("fast-forward") && i.appendChild(se.createButton.call(this, "fast-forward")),
            this.config.controls.includes("progress")) {
                ...
                i.appendChild(this.elements.progress)
            }
            if (this.config.controls.includes("current-time") && i.appendChild(se.createTime.call(this, "currentTime")),
            this.config.controls.includes("duration") && i.appendChild(se.createTime.call(this, "duration")),
            this.config.controls.includes("mute") && i.appendChild(se.createButton.call(this, "mute")),
            ...
            if (this.config.controls.includes("captions") && i.appendChild(se.createButton.call(this, "captions")),
            this.config.controls.includes("settings") && !o.empty(this.config.settings)) {
                var l = w("div", {
                    class: "plyr__menu",
                    hidden: ""
                });
            ...
            return this.config.controls.includes("pip") && D.pip && i.appendChild(se.createButton.call(this, "pip")),
            this.config.controls.includes("airplay") && D.airplay && i.appendChild(se.createButton.call(this, "airplay")),
            this.config.controls.includes("fullscreen") && i.appendChild(se.createButton.call(this, "fullscreen")),
            this.config.controls.includes("play-large") && this.elements.container.appendChild(se.createButton.call(this, "play-large")),
            this.elements.controls = i,
            this.isHTML5 && se.setQualityMenu.call(this, F.getQualityOptions.call(this)),
        ...
        inject: function() {
            ...
            var r, l = void 0;
            if (o.string(this.config.selectors.controls.container) && (l = document.querySelector(this.config.selectors.controls.container)),
            o.element(l) || (l = this.elements.container),
            o.element(i) ? l.appendChild(i) : i && l.insertAdjacentHTML("beforeend", i),
            o.element(this.elements.controls) || se.findElements.call(this),
            window.navigator.userAgent.includes("Edge") && (r = l,
            setTimeout(function() {
                P(r, !0),
                r.offsetHeight,
                P(r, !1)
    ...
    var oe = {
        setup: function() {
            if (this.supported.ui)
                if (!this.isVideo || this.isYouTube || this.isHTML5 && !D.textTracks)
                    o.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && se.setCaptionsMenu.call(this);
                else {
                    var e, t;
                    if (o.element(this.elements.captions) || (this.elements.captions = w("div", S(this.config.selectors.captions)),
                    e = this.elements.captions,
                    (t = this.elements.wrapper).parentNode.insertBefore(e, t.nextSibling)),
                    V.isIE && window.URL) {
                    ...
                    if (o.boolean(s) || (s = this.config.captions.active),
        ...
        update: function() {
            ...
            (l && this.language !== a || !t.includes(r)) && (oe.setLanguage.call(this, a),
            oe.toggle.call(this, n && l)),
            N(this.elements.container, this.config.classNames.captions.enabled, !o.empty(t)),
            (this.config.controls || []).includes("settings") && this.config.settings.includes("captions") && se.setCaptionsMenu.call(this)
        },
        toggle: function(e) {
            var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
            if (this.supported.ui) {
                ...
                if (a !== i) {
                    ...
                    !this.language && a && !t) {
                        ...
                        return this.captions.language = r.language,
                    ...
                    m.call(this, this.media, a ? "captionsenabled" : "captionsdisabled")
                }
            }
        },
        set: function(e) {
        ...
        getLabel: function(e) {
            var t = e;
            return !o.track(t) && D.textTracks && this.captions.toggled && (t = oe.getCurrentTrack.call(this)),
            o.track(t) ? o.empty(t.label) ? o.empty(t.language) ? $("enabled", this.config) : e.language.toUpperCase() : t.label : $("disabled", this.config)
        },
    ...
    function me() {
        if (this.enabled) {
            ...
            m.call(this.player, this.target, this.active ? "enterfullscreen" : "exitfullscreen", !0),
            V.isIos || function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null
                  , t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                if (o.element(e)) {
    ...
    var ge = function() {
        ...
        return g(e, [{
            key: "update",
            value: function() {
                this.enabled ? this.player.debug.log((e.native ? "Native" : "Fallback") + " fullscreen enabled") : this.player.debug.log("Fullscreen not supported and fallback disabled"),
                N(this.player.elements.container, this.player.config.classNames.fullscreen.enabled, this.enabled)
            }
        }, {
            key: "enter",
            value: function() {
            ...
            key: "prefix",
            get: function() {
                if (o.function(document.exitFullscreen))
                    return "";
                var e = "";
                return ["webkit", "moz", "ms"].some(function(t) {
                    return !(!o.function(document[t + "ExitFullscreen"]) && !o.function(document[t + "CancelFullScreen"])) && (e = t,
                    !0)
                }),
                e
            }
    ...
    var ve = {
        addStyleHook: function() {
            N(this.elements.container, this.config.selectors.container.replace(".", ""), !0),
            N(this.elements.container, this.config.classNames.uiSupported, this.supported.ui)
        },
        ...
        build: function() {
            ...
            o.element(this.elements.controls) || (se.inject.call(this),
            ...
            N(this.elements.container, this.config.classNames.pip.supported, D.pip && this.isHTML5 && this.isVideo),
            N(this.elements.container, this.config.classNames.airplay.supported, D.airplay && this.isHTML5),
            N(this.elements.container, this.config.classNames.isIos, V.isIos),
            N(this.elements.container, this.config.classNames.isTouch, this.touch),
            this.ready = !0,
            setTimeout(function() {
                m.call(e, e.media, "ready")
            }, 0),
            ve.setTitle.call(this),
            this.poster && ve.setPoster.call(this, this.poster, !1).catch(function() {}),
            this.config.duration && se.durationUpdate.call(this)
        },
        setTitle: function() {
            var e = $("play", this.config);
            if (o.string(this.config.title) && !o.empty(this.config.title) && (e += ", " + this.config.title),
        ...
        setPoster: function(e) {
            ...
            .call(this).then(function() {
                ...
                throw e === t.poster && ve.togglePoster.call(t, !1),
                i
            }).then(function() {
                if (e !== t.poster)
        ...
        checkPlaying: function(e) {
            var t = this;
            N(this.elements.container, this.config.classNames.playing, this.playing),
            N(this.elements.container, this.config.classNames.paused, this.paused),
            N(this.elements.container, this.config.classNames.stopped, this.stopped),
        ...
        return g(e, [{
            ...
            value: function(e) {
                ...
                if (!(e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) && o.number(i)) {
                    if (n) {
                        var s = q();
                        if (o.element(s) && s !== this.player.elements.inputs.seek && M(s, this.player.config.selectors.editable))
                            return;
                        ...
                        !this.player.fullscreen.enabled && this.player.fullscreen.active && 27 === i && this.player.fullscreen.toggle(),
                        this.lastKey = i
                    } else
                        this.lastKey = null
                }
            ...
            value: function() {
                this.player.touch = !0,
                N(this.player.elements.container, this.player.config.classNames.isTouch, !0)
            }
        }, {
            key: "global",
            value: function() {
                var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                this.player.config.keyboard.global && u.call(this.player, window, "keydown keyup", this.handleKey, e, !1),
                u.call(this.player, document.body, "click", this.toggleMenu, e),
                h.call(this.player, document.body, "touchstart", this.firstTouch)
            }
        }, {
            key: "container",
            value: function() {
                ...
                d.call(this.player, this.player.elements.container, "focusout", function(t) {
                ...
                d.call(this.player, this.player.elements.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", function(t) {
                    ...
                    "enterfullscreen" === t.type && (i.pressed = !1,
                    i.hover = !1);
                    var n = 0;
                    ["touchstart", "touchmove", "mousemove"].includes(t.type) && (ve.toggleControls.call(e.player, !0),
            ...
            value: function() {
                ...
                this.player.supported.ui && this.player.config.clickToPlay && !this.player.isAudio) {
                    ...
                    d.call(this.player, t, "click", function() {
                        e.player.config.hideControls && e.player.touch && !e.player.paused || (e.player.paused ? e.player.play() : e.player.ended ? (e.player.restart(),
                        e.player.play()) : e.player.pause())
                    })
                }
                ...
                d.call(this.player, this.player.media, i, function(t) {
                    ...
                    m.call(e.player, e.player.elements.container, t.type, !0, n)
                })
            }
        }, {
            key: "controls",
            value: function() {
                ...
                n(this.player.elements.buttons.restart, "click", this.player.restart, "restart"),
                n(this.player.elements.buttons.rewind, "click", this.player.rewind, "rewind"),
                n(this.player.elements.buttons.fastForward, "click", this.player.forward, "fastForward"),
                n(this.player.elements.buttons.mute, "click", function() {
                    e.player.muted = !e.player.muted
                }, "mute"),
                n(this.player.elements.buttons.captions, "click", function() {
                    return e.player.toggleCaptions()
                }),
                n(this.player.elements.buttons.fullscreen, "click", function() {
                    e.player.fullscreen.toggle()
                }, "fullscreen"),
                n(this.player.elements.buttons.pip, "click", function() {
                    e.player.pip = "toggle"
                }, "pip"),
                n(this.player.elements.buttons.airplay, "click", this.player.airplay, "airplay"),
                n(this.player.elements.buttons.settings, "click", function(t) {
                ...
                n(this.player.elements.settings.form, "click", function(t) {
                    ...
                    if (M(t.target, e.player.config.selectors.inputs.language))
                        i(t, function() {
                            e.player.currentTrack = Number(t.target.value),
                            n()
                        }, "language");
                    else if (M(t.target, e.player.config.selectors.inputs.quality))
                        i(t, function() {
                            e.player.quality = t.target.value,
                            n()
                        }, "quality");
                    else if (M(t.target, e.player.config.selectors.inputs.speed))
                        i(t, function() {
                ...
                n(this.player.elements.inputs.seek, "mousedown mouseup keydown keyup touchstart touchend", function(t) {
                    ...
                    if ("keydown" !== a && "keyup" !== a || 39 === n || 37 === n) {
                        ...
                        s && r ? (i.removeAttribute("play-on-seeked"),
                        e.player.play()) : !r && e.player.playing && (i.setAttribute("play-on-seeked", ""),
                        e.player.pause())
                    }
                }),
                n(this.player.elements.inputs.seek, t, function(t) {
                    ...
                    e.player.currentTime = n / i.max * e.player.duration
                }, "seek"),
                this.player.config.toggleInvert && !o.element(this.player.elements.display.duration) && n(this.player.elements.display.currentTime, "click", function() {
                    0 !== e.player.currentTime && (e.player.config.invertTime = !e.player.config.invertTime,
                    se.timeUpdate.call(e.player))
                }),
                n(this.player.elements.inputs.volume, t, function(t) {
                    e.player.volume = t.target.value
                }, "volume"),
                V.isWebkit && Array.from(x.call(this.player, 'input[type="range"]')).forEach(function(t) {
                ...
                n(this.player.elements.controls, "focusin focusout", function(t) {
                    var i = e.player
                      ...
                      , a = i.elements
                      , s = i.timers;
                    if (N(a.controls, n.classNames.noTransition, "focusin" === t.type),
    ...
    var ke, we = (function(e, t) {
        ...
        i = function() {
            ...
            function r(t, i, n, a) {
                var s, l, o = document, c = n.async, u = (n.numRetries || 0) + 1, d = n.before || e, p = t.replace(/^(css|img)!/, "");
                a = a || 0,
                /(^css!|\.css$)/.test(t) ? (s = !0,
                (l = o.createElement("link")).rel = "stylesheet",
                l.href = p) : /(^img!|\.(png|gif|jpg|svg)$)/.test(t) ? (l = o.createElement("img")).src = p : ((l = o.createElement("script")).src = t,
                l.async = void 0 === c || c),
            ...
            function l(e, i, n) {
                ...
                !function(e, t, i) {
                    var n, a, s = (e = e.push ? e : [e]).length, l = s, o = [];
    ...
    var Ce = {
        setup: function() {
            ...
            o.object(window.Vimeo) ? Ce.ready.call(this) : Te(this.config.urls.vimeo.sdk).then(function() {
                Ce.ready.call(e)
            }).catch(function(t) {
        ...
        setAspectRatio: function(e) {
            var t = (o.string(e) ? e : this.config.ratio).split(":")
              , i = v(t, 2)
              , n = 100 / i[0] * i[1];
            if (this.elements.wrapper.style.paddingBottom = n + "%",
            this.supported.ui) {
                var a = (240 - n) / 4.8;
        ...
        ready: function() {
            ...
            var a, s = (a = n,
            o.empty(a) ? null : o.number(Number(a)) ? a : a.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : a), r = w("iframe"), l = W(t.config.urls.vimeo.iframe, s, i);
            ...
            t.embed.on("progress", function(e) {
                ...
                1 === parseInt(e.percent, 10) && m.call(t, t.media, "canplaythrough"),
                t.embed.getDuration().then(function(e) {
            ...
            t.embed.on("seeked", function() {
                t.media.seeking = !1,
                m.call(t, t.media, "seeked")
            }),
            t.embed.on("ended", function() {
                t.media.paused = !0,
                m.call(t, t.media, "ended")
            }),
            t.embed.on("error", function(e) {
                t.media.error = e,
                m.call(t, t.media, "error")
            }),
            setTimeout(function() {
    ...
    var Pe, Ne = {
        setup: function() {
            ...
            o.object(window.YT) && o.function(window.YT.Player) ? Ne.ready.call(this) : (Te(this.config.urls.youtube.sdk).catch(function(t) {
        ...
        ready: function() {
            ...
            if (o.empty(t) || !t.startsWith("youtube-")) {
                ...
                var n, a = (n = i,
                o.empty(n) ? null : n.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : n), s = e.provider + "-" + Math.floor(1e4 * Math.random()), r = w("div", {
                    id: s,
                    poster: e.poster
                });
                e.media = E(r, e.media);
                    ...
                    events: {
                        ...
                        onReady: function(t) {
                            ...
                            e.timers.buffering = setInterval(function() {
                                ...
                                (null === e.media.lastBuffered || e.media.lastBuffered < e.media.buffered) && m.call(e, e.media, "progress"),
                        ...
                        onStateChange: function(t) {
                            ...
                            case 0:
                                ...
                                n.playVideo()) : m.call(e, e.media, "ended");
                                break;
                            case 1:
                                e.media.paused && !e.embed.hasPlayed ? e.media.pause() : (Se.call(e, !0),
                                ...
                                m.call(e, e.media, "durationchange")),
                                se.setQualityMenu.call(e, (i = n.getAvailableQualityLevels(),
                                o.empty(i) ? i : G(i.map(function(e) {
                                    return Ee(e)
                                })))));
                                break;
                            case 2:
        ...
        setup: function() {
            this.media ? (N(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0),
            N(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0),
            this.isEmbed && N(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0),
            this.isVideo && (this.elements.wrapper = w("div", {
            ...
            this.isHTML5 ? F.extend.call(this) : this.isYouTube ? Ne.setup.call(this) : this.isVimeo && Ce.setup.call(this)) : this.debug.warn("No media element found!")
        }
    }, Me = function() {
        function e(t) {
            var i = this;
        ...
        return g(e, [{
            ...
            value: function(e) {
                ...
                o.empty(this.cuePoints) || this.cuePoints.forEach(function(e) {
            ...
            value: function() {
                ...
                this.player.on("seeked", function() {
                    ...
                    o.empty(e.cuePoints) || e.cuePoints.forEach(function(n, a) {
                        i < n && n < t && (e.manager.discardAdBreak(),
            ...
            key: "trigger",
            value: function(e) {
                for (var t = this, i = arguments.length, n = Array(i > 1 ? i - 1 : 0), a = 1; a < i; a++)
                    n[a - 1] = arguments[a];
                var s = this.events[e];
            ...
            key: "on",
            value: function(e, t) {
                return o.array(this.events[e]) || (this.events[e] = []),
            ...
            value: function(e) {
                o.nullOrUndefined(this.safetyTimer) || (this.player.debug.log("Safety timer cleared from: " + e),
        ...
        change: function(e) {
            var t = this;
            U(e, "sources.length") ? (F.cancelRequests.call(this),
            this.destroy.call(this, function() {
                t.options.quality = [],
                A(t.media),
                t.media = null,
                o.element(t.elements.container) && t.elements.container.removeAttribute("class");
                var i = e.sources
                  , n = e.type
                  , a = v(i, 1)[0]
                  , s = a.provider
                ...
                Le.setup.call(t),
                t.isHTML5 && ("tracks"in e && xe.insertElements.call(t, "track", e.tracks),
                t.media.load()),
                (t.isHTML5 || t.isEmbed && !t.supported.ui) && ve.build.call(t),
                t.fullscreen.update()
        ...
        function e(t, i) {
            ...
            this.touch = D.touch,
            this.media = t,
            o.string(this.media) && (this.media = document.querySelectorAll(this.media)),
            (window.jQuery && this.media instanceof jQuery || o.nodeList(this.media) || o.array(this.media)) && (this.media = this.media[0]),
            this.config = z({}, ce, e.defaults, i || {}, function() {
                try {
            ...
            !o.nullOrUndefined(this.media) && o.element(this.media))
                if (this.media.plyr)
                    ...
                    if (D.check().api) {
                        ...
                        case "div":
                            ...
                            o.element(r)) {
                                ...
                                l.searchParams.length) {
                                    ...
                                    this.isYouTube ? this.config.playsinline = c.includes(l.searchParams.get("playsinline")) : this.config.playsinline = !0
                                }
                            } else
                                this.provider = this.media.getAttribute(this.config.attributes.embed.provider),
                                this.media.removeAttribute(this.config.attributes.embed.provider);
                            if (o.empty(this.provider) || !Object.keys(ue).includes(this.provider))
                        ...
                        this.supported = D.check(this.type, this.provider, this.config.playsinline),
                        this.supported.api ? (this.eventListeners = [],
                        this.listeners = new be(this),
                        this.storage = new X(this),
                        this.media.plyr = this,
                        o.element(this.elements.container) || (this.elements.container = w("div"),
                        b(this.media, this.elements.container)),
                        ve.addStyleHook.call(this),
                        Le.setup.call(this),
                        this.config.debug && d.call(this, this.elements.container, this.config.events.join(" "), function(e) {
                            n.debug.log("event: " + e.type)
                        }),
                        (this.isHTML5 || this.isEmbed && !this.supported.ui) && ve.build.call(this),
        ...
        return g(e, [{
            ...
            value: function() {
                ...
                this.restart()) : o.function(this.media.stop) && this.media.stop()
            }
        }, {
            key: "restart",
            value: function() {
            ...
            value: function(e) {
                if (this.supported.ui && !this.isAudio) {
                    ...
                    if (n && this.config.controls.includes("settings") && !o.empty(this.config.settings) && se.toggleMenu.call(this, !1),
                    n !== t) {
            ...
            value: function(e) {
                ...
                if (this.ready) {
                    var n = function() {
                        ...
                        t.embed = null,
                        i ? (Object.keys(t.elements).length && (A(t.elements.buttons.play),
                    ...
                    null !== this.embed && o.function(this.embed.destroy) && this.embed.destroy(),
            ...
            set: function(e) {
                ...
                t < .1 && (t = .1),
                t > 2 && (t = 2),
                this.config.speed.options.includes(t) ? (this.config.speed.selected = t,
                this.media.playbackRate = t) : this.debug.warn("Unsupported speed (" + t + ")")
            },
            get: function() {
            ...
            value: function(t) {
                var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                  , n = null;
                return o.string(t) ? n = Array.from(document.querySelectorAll(t)) : o.nodeList(t) ? n = Array.from(t) : o.array(t) && (n = t.filter(o.element)),
                o.empty(n) ? null : n.map(function(t) {
                    return new e(t,i)
                })
            }
        }]),
